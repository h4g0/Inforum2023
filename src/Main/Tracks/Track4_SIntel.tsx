    ...
    return <><div className="Accommodation">
        ...
        <div className='Tracks'>
            ...
            <p>A sofisticação de sistemas informáticos modernos exige uma cada vez maior integração de mecanismos avançados e inteligentes de suporte à tomada de decisão e de interação com humanos. O tópico Sistemas Inteligentes agrega a inclusão em sistemas informáticos de componentes relacionados com a tomada de decisão inteligente.
                ...
                De facto, temos assistido, nos últimos anos, a uma relevância crescente de soluções baseadas em inteligência artificial, com promessas crescentes de contribuirem para a resolução de problemas cada vez mais exigentes. As abordagens baseadas em inteligência artificial deixaram de gravitar em redor dos meios científicos e académicos, encontrando-se em franca expansão em diversas áreas e mercados.
