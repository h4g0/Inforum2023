    ...
    return <><div className="Accommodation">
        ...
        <div className='TracksOne'>
            ...
            <p>O Colégio de Informática da Ordem dos Engenheiros promove uma sessão no Inforum 2023 com o objetivo de discutir trabalhos realizados por jovens investigadores e outros profissionais que se relacionam com preocupações sobre impactos sócio-profissionais na sociedade moderna do desenvolvimento, operação e utilização de tecnologia de produtos e serviços baseados em tecnologias da informação.
                ...
                Serão considerados trabalhos discutindo a perspectiva das implicações éticas e legais da tecnologia digital, bem como os desafios e oportunidades que ela traz como a desinformação, privacidade. Serão ainda considerados artigos centrando-se no impacto social e económico das tendências atuais e futuras da informática, incluindo a inteligência artificial, a computação em nuvem, a robótica, a realidade virtual, a internet das coisas e outras tecnologias emergentes.

                Serão ainda considerados estudos sobre as temáticas da cyberbullying, da  igualdade, equidade e acessibilidade em engenharia informática, quer no contexto empresarial, quer no contexto académico, ou mesmo na educação universitária e pré Universitária. Neste último caso, podem ser apresentados resultados com vista a boas práticas e produção de princípios orientadores e medidas que ajudem a consciencializar quer as entidades (empresariais, legislativas ou outras) quer os profissionais de modo a combater os problemas relacionados com a falta de igualdade e equidade na profissão, promovendo a inclusão.

                As contribuições esperadas poderão ser de dois tipos:

                1) Trabalhos originais, bem fundamentados, podendo ser estudos empíricos, revisões sistemáticas, casos de estudo, levantamento de temas para discussão nas sessões ou mesmo acerca da construção de ferramentas voltadas para as temáticas propostas.
                2) Artigos de opinião, visão ou método que levantam a temática para discussão durante a sessão. Este artigo deverá introduzir o tema e identificar os pontos de polémica, ou tomada de posição dos autores.
