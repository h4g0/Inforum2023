...
interesse desta sessão.
        ...
        <div className='InsideTracksTwo'>
            ...
            <ul>
                ...
                <li>José Simão, Instituto Superior de Engenharia de Lisboa - Instituto Politécnico de Lisboa / INESC-ID Lisboa</li>
                ...
                <li>Carlos Goncalves,  Instituto Superior de Engenharia de Lisboa, Instituto Politécnico de LisboaInstituto Politécnico de Lisboa</li>
                <li>Luís Antunes,  Faculdade de Ciências da Universidade do Porto -  Universidade do Porto</li>
                <li>Carlos Baquero,  Faculdade de Engenharia da Universidade do Porto - Universidade do Porto</li>
